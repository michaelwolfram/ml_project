...
validDepths = [1,2,4,6,8,10,12,14,16];
numTrees = [1,5,10,15,20,25,30];
...
ylabel('Depth of each Fern');
axis([0.5 7.5 0.5 9.5]);
axis('image');
...
hold on;
colors=['m','k','g','b','r','b'];
for i=1:size(accuracies1270,1)
    plot(accuracies1270(:,i),colors(i));
end
